...
*/
#define LxMid 285              // Left X axis centerpoint (mine was near 330)
...
#define LTopLidShut  235        // top eyelid shut limit (from 'buttonBlink')
#define LTopLidOpen  350        // top eyelid open limit (from 'buttonBlink')
...
#define RTopLidShut  355        // top eyelid shut limit (from 'buttonBlink')
#define RTopLidOpen  240        // top eyelid open limit (from 'buttonBlink')
...
void loop() {
  ...
  if(state){
    ...
    actionCycler(1);      // Picks one of the 7 listed actions
    actionCycler(2);      // Picks one of the 7 listed actions
